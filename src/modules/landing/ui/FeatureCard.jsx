...
function FeatureCard({ icon, title, description }) {
  return (
    <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md border border-primary/20 dark:border-primary/20 hover:border-accent transition-all duration-300 hover:translate-y-[-5px]">
